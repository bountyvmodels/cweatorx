...
// Metric Cards Component for Cweators (different stats than Agency)
const MetricCard = ({ 
  number, 
  title, 
  bgColor, 
...
export default function CweatorsDashboard() {
  ...
  // Cweator-specific metrics (different from Agency)
  const metrics = [
    {
      number: "2.4K",
    ...
    },
    {
      number: "12",
      title: "ACTIVE LINKS", 
      bgColor: "#64b5f6" // Blue like your design
    }
  ];

  return (
    <PageContainer title="Cweators Dashboard" description="Cweator Management Dashboard">
      <Box sx={{ p: 3 }}>
