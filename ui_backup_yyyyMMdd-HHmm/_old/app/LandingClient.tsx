    ...
    <main className="bg-white text-pink-600 min-h-screen w-full overflow-x-hidden">
      ...
      <section className="mt-16 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {['MLM Affiliate Ready', 'Cweator Hub', 'Cweator Uni'].map((title, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <p className="text-pink-700 mt-1 text-sm">
                {idx === 0 ? 'Grow through layered referrals and earn passively.'
                : idx === 1 ? 'Monetize your content & community like OnlyFans or Patreon.'
